...
* 문제해결 방법
  * 환경구성
    ...
    * DB연동은 [Kys_project/src/main/webapp/WEB-INF/spring]
    (https://github.com/kys2357/ys89/tree/master/src/main/webapp/WEB-INF/spring)/root-context.xml에 로컬에서 테스트 할 때는<br>
